...
{
    public class RobotMoveRightCommandTests
    {
        private readonly string _command = "right()";

        [Theory]
        [ClassData(typeof(RobotMoveRightTestCases))]
        public void MoveRightCommand_Should_Work(RobotMoveTestCase data)
        {
            // Arrange
            ...
            var command = new RobotMoveRightCommandMoq(tableService.Object, validationService.Object);
